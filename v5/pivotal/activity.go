...
func (service *ActivityService) List(projectID int, version int) ([]*Story, error) {
...
// func (service *ActivityService) List() ([]*Project, *http.Response, error) {
...
// 	resp, err := a.client.Do(req, &projects)
// 	if err != nil {
// 		return nil, resp, err
// 	}
//
...
// }
//
// func (a *ActivitiesService) Get(projectId int) (*Project, *http.Response, error) {
...
//
// 	var project Project
// 	resp, err := a.client.Do(req, &project)
// 	if err != nil {
// 		return nil, resp, err
// 	}
//
